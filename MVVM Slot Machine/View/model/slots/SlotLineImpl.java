...
public class SlotLineImpl implements SlotLine {
	...
	public boolean equals(SlotLine slotLine) {
		...
		return slotLine != null && slot1.equals(slotLine.getSlot1()) && slot2.equals(slotLine.getSlot2())
	...
	public boolean equals(Object obj) {
		...
		return obj instanceof SlotLine ? equals((SlotLine) obj) : false;
	...
	public String toString() {
		...
		return String.format("%s | %-10s | %-10s | %-11s|", this.lineNum, this.slot1,
