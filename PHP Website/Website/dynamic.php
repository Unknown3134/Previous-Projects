...
<head>
 ...
 <h3 id = 'dyn'>2D Array of Letters (Dynamic content) </h3>
 <div class = 'parallax2'></div>

 <section id ='dynamic' class ='letter'>
  ...
  <?php   loadLetters(); 
    ...
    <div><a class= 'links' id= 'cite' href="https://www.freepik.com/free-photos-vectors/banner">Banner vector created by macrovector - www.freepik.com</a></div> 
    </footer>
